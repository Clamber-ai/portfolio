        ...
        >
          ...
          <motion.div className="lg:col-span-3" variants={itemVariants}>
            <form onSubmit={handleSubmit} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00E6A0]"
                    required
                  />
                </div>
                <div>
              ...
              <motion.button
                type="submit"
                className="w-full bg-gradient-to-r from-[#00E6A0] to-[#00B2FF] text-black font-medium py-3 px-6 rounded-lg hover:opacity-90 transition-opacity"
